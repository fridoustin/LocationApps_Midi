...
class LokasiTopTabBar extends StatelessWidget {
  final int currentIndex;
  final Function(int) onTabChanged;

  const LokasiTopTabBar({
    super.key,
    ...
    return Container(
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          final tabWidth = constraints.maxWidth / 3; // Ubah sesuai jumlah tab
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  _buildTab('Progress KPLT', 2, tabWidth)
