// lib/features/home/presentation/widgets/monthly_kplt_barchart.dart
...
class MonthlyKpltBarChart extends StatelessWidget {
  final List<MonthlyData> data;
  final int? year;

  const MonthlyKpltBarChart({super.key, required this.data, this.year});

  @override
  Widget build(BuildContext context) {
    final maxYValue = _calculateMaxY(data);

    String chartTitle = "Total KPLT";
    if (year != null) {
      chartTitle = "Total KPLT - Tahun $year";
    }
                ...
                barTouchData: BarTouchData(
                  touchTooltipData: BarTouchTooltipData(
                    ...
                    getTooltipItem: (group, groupIndex, rod, rodIndex) {
                      ...
                      final other = monthData.total - monthData.approved;
  ...
  List<BarChartGroupData> _generateBarGroups(List<MonthlyData> displayData) {
    return List.generate(displayData.length, (index) {
      ...
      final double approvedEnd = item.approved.toDouble();
      final double totalEnd = item.total.toDouble();
      ...
      return BarChartGroupData(
        ...
        barRods: [
          BarChartRodData(
            ...
            rodStackItems: [
              BarChartRodStackItem(0, approvedEnd, AppColors.successColor),
  ...
  Widget _buildLegend() {
    return Row(
      ...
      children: [
        _Indicator(color: AppColors.successColor, text: 'Approved'),
        _Indicator(color: AppColors.warningColor, text: 'Other'),
      ],
    );
  }
}
