// lib/features/form_kplt/presentation/widgets/kplt_filter_dialog.dart
...
class KpltFilterDialog extends StatefulWidget {
  ...
  const KpltFilterDialog({super.key, required this.initialFilter});

  @override
  State<KpltFilterDialog> createState() => _KpltFilterDialogState();
}

class _KpltFilterDialogState extends State<KpltFilterDialog> {
  String? _selectedStatus;
  DateTime? _selectedMonthYear;

  final List<String> _statuses = ['Need Input', 'In Progress', 'Waiting for Forum', 'OK', 'NOK',];
