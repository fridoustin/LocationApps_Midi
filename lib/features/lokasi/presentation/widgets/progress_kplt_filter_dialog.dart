...
class ProgressKpltFilterDialog extends StatefulWidget {
  final KpltFilter initialFilter;
  const ProgressKpltFilterDialog({super.key, required this.initialFilter});

  @override
  State<ProgressKpltFilterDialog> createState() =>
      _ProgressKpltFilterDialogState();
}

class _ProgressKpltFilterDialogState extends State<ProgressKpltFilterDialog> {
  ...
  void initState() {
    ...
    if (widget.initialFilter.year != null &&
        widget.initialFilter.month != null) {
      _selectedMonthYear =
          DateTime(widget.initialFilter.year!, widget.initialFilter.month!);
    }
  }
